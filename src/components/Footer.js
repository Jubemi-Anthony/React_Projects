...
function Footer({cartItems, starItems}){
    return(
        <div className="Footer">
            ...
            <Link to="/Cart">
                <div className="page">
                    ...
                    <p>Cart<span id={cartItems.length === 0 ? "" : 'circle'} className="length">{cartItems.length === 0 ? "" : cartItems.length}</span></p>
                </div>
            </Link>
            <Link to="/Starred">
                <div className="page">
                    <img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-star-outline-64.png" alt="Starred" />
                    <p>Starred<span id={starItems.length === 0 ? "" : 'circle'} className="length">{starItems.length === 0 ? "" : starItems.length}</span></p>
                </div>
            </Link>
            <Link to="/Chat">
                <div className="page">
